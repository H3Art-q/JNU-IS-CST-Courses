...
public class QuizSolver {
     ...
     * @param solvableList   Receive a status list to judge whether the expression should be solved
     * @param precision      Receive a specified precision for calculating final result
     */
    QuizSolver(List<String[]> expressionList, List<Boolean> solvableList, int precision) {
